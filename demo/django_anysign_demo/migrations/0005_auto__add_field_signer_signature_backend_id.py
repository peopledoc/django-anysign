...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signer.signature_backend_id'
        db.add_column(u'django_anysign_demo_signer', 'signature_backend_id',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=100, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Signer.signature_backend_id'
        db.delete_column(u'django_anysign_demo_signer', 'signature_backend_id')
