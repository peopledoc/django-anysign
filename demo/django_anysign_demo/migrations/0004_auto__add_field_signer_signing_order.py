...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signer.signing_order'
        db.add_column(u'django_anysign_demo_signer', 'signing_order',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Signer.signing_order'
        db.delete_column(u'django_anysign_demo_signer', 'signing_order')
